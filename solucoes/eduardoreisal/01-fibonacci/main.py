...
class Main:
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(description='Get first n nums from Fibonacci sequence')
        self.parser.add_argument('--num', help='python main.py --num 10 | get first 10 nums from Fibonacci sequence')
    ...
    def validate_user_input_int(self, value) -> int:
        ...
        try:
            ...
            value = input('How many of the n nums from Fibonacci sequence would you like to get: ')
